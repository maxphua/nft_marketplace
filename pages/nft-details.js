...
const NFTDetails = () => {
  ...
  useEffect(() => {
    ...
    setNft(router.query); // contain all the propertis of the url query
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10">
          <p className="font-poppins dark:text-white text-nft-black-1 text-xs linlg:text-base font-normal">
            Creator
          </p>
          <div className="flex flex-row items-center mt-3">
            <div className="relative w-12 h-12 minlg:w-10 minlg:h-10 mr-2">
      ...
      <Modal
        header="Buying NFT..."
        body={(
          <div className="felxCenter flex-col text-center">
            <div className="relative w-52 h-52">
              <Loader />
            </div>
          </div>
