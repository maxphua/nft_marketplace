...
const FooterLinks = ({ heading, items }) => (
  <div className="flex-1 justify-start items-start">
    ...
    {items.map((item, index) => (
      <p key={index} className="font-poppins dark:text-white text-nft-black-1 font-normal text-base cursor-pointer dark:hover:text-nft-gray-1 hover:text-nft-gray-1 my-3">{item}</p>
    ))}
  </div>
);
...
const Footer = () => {
  ...
  return (
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
      ...
      {/* Logo and social media session */}
      <div className="flexCenter w-full mt-5 border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-4 px-16">
        <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          <p>CryptoKet, Inc. All Right Reserved.</p>
